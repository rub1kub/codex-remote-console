...
- модели загружаются динамически через Codex `model/list`, поэтому новые модели появляются без обновления приложения; офлайн-резерв уже содержит GPT-5.6 Sol, Terra и Luna;
- уровни рассуждения и скорость зависят от возможностей выбранной модели; подтверждения и sandbox остаются в настройках поля ввода и проекта.
