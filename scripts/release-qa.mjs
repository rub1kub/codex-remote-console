...
for (const script of ["build", "test:task-protocol", "test:model-catalog", "test:message-history", "test:codex-history", "test:ui", "test:project-tools", "test:shell", "smoke:ssh", "qa:release"]) {
